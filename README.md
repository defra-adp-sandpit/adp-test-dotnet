...
adp-test-dotnet Dotnet service.
...
| APPINSIGHTS_CLOUDROLE        | Role used for filtering metrics | no       |         |       | Set to `adp-test-dotnet-local` in docker compose files                                                                |
...
`docker-compose -p adp-test-dotnet-test -f docker-compose.yaml -f docker-compose.test.yaml up`
...
`docker-compose -p adp-test-dotnet-test -f docker-compose.yaml -f docker-compose.test.watch.yaml up`
