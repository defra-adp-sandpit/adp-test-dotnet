...
using Adp.Test.Dotnet.Api.Config;
using Adp.Test.Dotnet.Api.Extensions;
using Adp.Test.Dotnet.Api.HealthChecks;
...
public static class Program
{
    ...
    public static void ConfigureServices(WebApplicationBuilder builder)
    {
        ...
        {
            config.SwaggerDoc("v1", new OpenApiInfo { Title = "Adp.Test.Dotnet", Version = "v1" });
        });
